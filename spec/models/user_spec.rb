...
RSpec.describe User, type: :model do
  ...
  context '新規登録できないとき' do
    ...
    it 'last_nameとfirst_nameが全角（漢字・ひらがな・カタカナ）でなければ登録できない' do
      user = FactoryBot.build(:user, last_name: 'test', first_name: 'test') 
      user.valid?
    ...
    it 'last_name_kanaとfirst_name_kanaが全角カタカナでなければ登録できない' do
      user = FactoryBot.build(:user, last_name: 'テスト', first_name: 'テスト', last_name_kana: 'test', first_name_kana: 'test') 
      user.valid?
